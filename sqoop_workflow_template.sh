#!bin/bash
gsutil mb -l us-east1 gs://DataE-Experiment_Bucket/
bucket="gs://DataE-Experiment_Bucket"
template_name="mysql_import"
cluster_name="sqoop-import"
instance_name="DataE-Experiment_Bucket:us-east1:mytest-instance"
...
--query "select * from testdb.customers and \$CONDITIONS" \
--target-dir $bucket/$table_name \
--split-by customerNumber -m 1 && 
